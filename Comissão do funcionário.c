...
int main() 
{
	...
	for(int i = 1; i <= 10; i++)
	{
		...
		{
			//Aqui vai repetir a instrução de pedir o valor do produto e logo fara o calculo
			do 
			{ 
				...
				//Aqui verificamos o valor de maiorVenda e recebe o vetor totalVenda
				if(maiorVenda == 0)
				{ 
					maiorVenda = comissao[i].totalVenda;
					//Então se o vetor for maior, significa que a venda foi maior que o maiorVenda
				}
				//Aqui verificamos o valor de menorVenda e recebe o vetor totalVenda
				if(menorVenda == 0){
					menorVenda = comissao[i].totalVenda;
					//Então se o vetor for menor, significa que a venda foi menor que o menorVenda
				}
				//Fazemos as operações lógicas para atribuirmos os valores gerais de venda para a maior venda
				if(comissao[i].totalVenda > maiorVenda)
				{
					maiorVenda = comissao[i].totalVenda;
				}
				//Fazemos as operações lógicas para atribuirmos os valores gerais de venda para a menor venda
